...
[Prisma Quick Start](https://www.prisma.io/docs/prisma-orm/quickstart/postgresql)
...
- DATABASE_URL : Session pool + Password
- DIRECT_URL : Transaction pool + Password
...
- From the shandcn Button component replace the following class:
  `active:not-aria-[haspopup]:translate-y-px` with following:
  `active:not-aria-[haspopup]:ring-2 active:not-aria-[haspopup]:ring-primary/50`

because any transform property to button states lead to wired buggs.
